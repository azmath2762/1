                    ...
                    try:
                        for t in temp:
                            ...
                            for current_item in product_det:
                                ...
                                tsp = max(tpid*o[5],current_item['new_sp'])
                                tpid = str(tpid)
                                torderid = o[1]
                                titemid = o[2]
                                ...
                                if tpid != '0' and torderdate != -1 and tdbd != -1 and gtmrpntrate != -1:
                                    with open(r'C:\Users\Administrator\PycharmProjects\pythonProject\split_data\split_data.csv','a',newline='') as f:
                                        wrtt=csv.writer(f)
...
#smart_api('P201021-70917CA48176')