...
with open('failed_records2.csv', "w", newline='') as f:
...
file=r'C:\Users\Administrator\PycharmProjects\pythonProject\flipkart_processing_code\failed_records1.csv'
...
with open(file, "r", newline='')as f1:
    ...
    for i in range(1,len(r)):
        ...
        try:
            ...
            with open('failed_records1.csv', "a", newline='') as f:
                thewriter = csv.writer(f)
